    ...
    <>
      ...
      <aside
        className={cn(
          ...
          isMobileOpen ? 'translate-x-0 h-screen' : '-translate-x-full md:translate-x-0',
          'w-80 md:w-auto',
              ...
              return (
                <li key={i}>
                  ...
                  >
                    ...
                    {!isExpanded && (
                      <div className="pointer-events-none absolute left-full top-1/2 -translate-y-1/2 ml-3 px-2 py-1 bg-popover text-sm text-popover-foreground rounded-md shadow-md opacity-0 group-hover:opacity-100 whitespace-nowrap border border-border z-50 transition-opacity duration-200">
                        {item.label}
                      </div>
                    )}
                  </Link>
